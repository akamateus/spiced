...
1. You created a folder called **session-notebook** in the last challenge, navigate to it.
...
In the last challenge you created a folder called **challenges**. Let's convert it into a repository. Repeat the steps form **Connect the Session Notebook to GitHub** but for **challenges**
