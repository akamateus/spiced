...
const firstAnimalStartingWithLetterG = animals.find((randomAnimal) =>
  randomAnimal.name.startsWith("g")
);
...
const animalWithWeightMoreThanFiveundredExists = animals.some(
  (animal) => animal.weight > 500
);
console.log(animalWithWeightMoreThanFiveundredExists);
