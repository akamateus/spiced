...
increaseByOneButton.addEventListener("click", () => {
  ...
  console.log("increasedVal: ", increasedVal);
});
​
increaseByFiveButton.addEventListener("click", () => {
  // 8. Increase the value of "operand1" by 5. Log the new value to the console.
  let increasedVal = operand1 + 5;
  console.log("increasedByFiveVal: ", increasedVal);
});
​
decreaseByOneButton.addEventListener("click", () => {
  // 7. Decrease the value of "operand1" by 1. Log the new value to the console.
  let decreasedVal = operand1 - 1;
  console.log("decreasedVal: ", decreasedVal);
});
​
decreaseByFiveButton.addEventListener("click", () => {
  // 8. Decrease the value of "operand1" by 5. Log the new value to the console.
  let decreasedVal = operand1 - 5;
  console.log("decreasedByFiveVal: ", decreasedVal);
});
​
multiplyByTwoButton.addEventListener("click", () => {
  // 11. Multiply the value of "operand1" by 2. Log the new value to the console.
  let multipliedVal = operand1 * 2;
  console.log("multipliedVal: ", multipliedVal);
});
​
divideByTwoButton.addEventListener("click", () => {
  // 12. Divide the value of "operand1" by 2. Log the new value to the console.
  let dividedVal = operand1 / 2;
  console.log("dividedVal: ", dividedVal);
});